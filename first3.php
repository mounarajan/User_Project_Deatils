...
<ul class="sub-tabs">
<li class="object-action modal"><a href="first3.php"><span>New Project</span></a></li>  
</ul>
</div>
...
$sel = mysql_select_db("u594173455_mini",$con); 
if(!$sel)
{
...
?>              
<?php
$que = mysql_query("select * from modify1 order by id asc");
if(!$que)
{
...
?>
<td class="">
<a class="cell-link"><?php echo $res['name']; ?></a>
</td>          
<td class="">
                        <a class="cell-link"><?php echo $res['contact']; ?></a>
                    </td>

                
                
                    <td class="">
                        <a class="cell-link"><?php echo $res['phone']; ?></a>
                    </td>

                
                
                    <td class="">
                        <a class="cell-link"><?php echo $res['email']; ?></a>
                    </td>
                
                                                                    <td class="action">
                        <a class="small-button  modal" href="#"  ><span id="opener<?php echo $res['id'];?>" class ="opener">Edit</span></a>
                    </td>

    
	<td class="action">
                        <a class="small-button danger modal" href="#"><span>Delete</span></a>
                    </td>

<div id="dialog<?php echo $res['id']; ?>" style="display:none;" title ="Edit">
  <form method="post" action="process.php?id=<?php echo $res['id']; ?>">
<pre>
Name<br>
<input type="text" name="name" required value="<?php echo $res['name'];?>" ><br>
Contact Person
<input type="text" name="contact" value="<?php echo $res['contact'];?>" required><br>
Email
<input type="text" name="email" value="<?php echo $res['email'];?>" required><br>
Phone number
...
<script type="text/javascript">
  $(function() {
	...
	$( "#opener<?php echo $res['id']; ?>" ).click(function() {
		$( "#dialog<?php echo $res['id']; ?>" ).css({'display':'block'});
      $( "#dialog<?php echo $res['id']; ?>" ).dialog();
    });
